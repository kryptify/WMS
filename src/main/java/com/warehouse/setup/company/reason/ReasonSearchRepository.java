...
public class ReasonSearchRepository {
    ...
    public ReasonSearchRepository(EntityManager entityManager) {
        this.entityManager = entityManager;
        this.criteriaBuilder = entityManager.getCriteriaBuilder();
    }

    public Page<Reason> findAllWithFilters(PageHelper page, ReasonRequest request) {
        CriteriaQuery<Reason> criteriaQuery = criteriaBuilder.createQuery(Reason.class);
        Root<Reason> rootObj = criteriaQuery.from(Reason.class);
        Join<Reason, PrimaryCompany> toPrimaryCompanyJoin = rootObj.join("primaryCompany");
        Join<Reason, User> toCreatedByUserJoin = rootObj.join("createdBy");
        Join<Reason, User> toModifiedByUserJoin = rootObj.join("modifiedBy");
        ...
        TypedQuery<Reason> typedQuery = entityManager.createQuery(criteriaQuery);
    ...
    private List<Predicate> getPredicate(ReasonRequest request, Root<Reason> rootObj) {
    ...
    private void setOrder(PageHelper page, CriteriaQuery<Reason> criteriaQuery, Root<Reason> rootObj) {
    ...
    private long getAllRecordsCount(Predicate predicate) {
        ...
        Root<Reason> countRoot = countQuery.from(Reason.class);
