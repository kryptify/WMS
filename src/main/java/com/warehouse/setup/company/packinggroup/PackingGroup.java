...
@Entity
@Table(name = "packing_group", schema = "public", uniqueConstraints = {
...
public class PackingGroup {
    ...
    public PackingGroup(Long id, String name, String code, String primaryCompanyName, String primaryCompanyCode,
    ...
    public String toString() {
        return "PackingGroup [code=" + code + ", createdAt=" + createdAt + ", id=" + id + ", modifiedAt=" + modifiedAt
                + ", name=" + name + ", primaryCompany=" + primaryCompany + ", primaryCompanyId=" + primaryCompanyId
                + "]";
    }
