...
@Repository
public class CustomerTypeSearchRepository {

    private final EntityManager entityManager;
    private final CriteriaBuilder criteriaBuilder;

    public CustomerTypeSearchRepository(EntityManager entityManager) {
        this.entityManager = entityManager;
        this.criteriaBuilder = entityManager.getCriteriaBuilder();
    }

    public Page<CustomerType> findAllWithFilters(PageHelper page, CustomerTypeRequest request) {
        CriteriaQuery<CustomerType> criteriaQuery = criteriaBuilder.createQuery(CustomerType.class);
        Root<CustomerType> rootObj = criteriaQuery.from(CustomerType.class);
        Join<CustomerType, PrimaryCompany> toPrimaryCompanyJoin = rootObj.join("primaryCompany");
        Join<CustomerType, User> toCreatedByUserJoin = rootObj.join("createdBy");
        Join<CustomerType, User> toModifiedByUserJoin = rootObj.join("modifiedBy");
        ...
        TypedQuery<CustomerType> typedQuery = entityManager.createQuery(criteriaQuery);
    ...
    private List<Predicate> getPredicate(CustomerTypeRequest request, Root<CustomerType> rootObj) {
    ...
    private void setOrder(PageHelper page, CriteriaQuery<CustomerType> criteriaQuery, Root<CustomerType> rootObj) {
    ...
    private long getAllRecordsCount(Predicate predicate) {
        ...
        Root<CustomerType> countRoot = countQuery.from(CustomerType.class);
