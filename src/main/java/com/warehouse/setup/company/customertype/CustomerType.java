...
@Entity
@Table(name = "customer_type", schema = "public", uniqueConstraints = {
...
public class CustomerType {
    ...
    public CustomerType(Long id, String name, String code, String primaryCompanyName, String primaryCompanyCode,
    ...
    public String toString() {
        return "CustomerType [code=" + code + ", createdAt=" + createdAt + ", createdBy=" + createdBy + ", createdById="
