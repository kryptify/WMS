...
public class CustomerShipToAddressRequest {
    ...
    public String toString() {
        return "CustomerShipToAddressRequest [addressLine1=" + addressLine1 + ", addressLine2=" + addressLine2
                + ", areaDialingCode=" + areaDialingCode + ", cityId=" + cityId + ", contactName=" + contactName
                + ", countryId=" + countryId + ", createdFrom=" + createdFrom + ", createdTo=" + createdTo
                + ", customerId=" + customerId + ", defaultWarehouseForAllocationId=" + defaultWarehouseForAllocationId
                + ", email=" + email + ", extensionNo=" + extensionNo + ", fax=" + fax + ", id=" + id
                + ", intlDialCode=" + intlDialCode + ", mobile=" + mobile + ", modifiedFrom=" + modifiedFrom
                + ", modifiedTo=" + modifiedTo + ", otherCity=" + otherCity + ", otherState=" + otherState + ", phone="
                + phone + ", postBox=" + postBox + ", postalCode=" + postalCode + ", primaryCompanyId="
                + primaryCompanyId + ", searchFor=" + searchFor + ", shipTo=" + shipTo + ", stateId=" + stateId + "]";
    }
