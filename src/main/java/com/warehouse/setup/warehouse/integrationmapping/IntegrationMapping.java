...
@Entity
@Table(name = "integration_mapping", schema = "public", uniqueConstraints = {
...
public class IntegrationMapping {
    ...
    public IntegrationMapping(Long id, Long warehouseId, String warehouseName, String warehouseCode, String code,
    ...
    public String toString() {
        return "IntegrationMapping [code=" + code + ", createdAt=" + createdAt + ", createdBy=" + createdBy
                ...
                + ", modifiedByUserName=" + modifiedByUserName + ", warehouse=" + warehouse + ", warehouseCode="
                + warehouseCode + ", warehouseId=" + warehouseId + ", warehouseName=" + warehouseName + "]";
    }
