...
@Repository
public class LocationRestrictionSearchRepository {

    private final EntityManager entityManager;
    private final CriteriaBuilder criteriaBuilder;

    public LocationRestrictionSearchRepository(EntityManager entityManager) {
        this.entityManager = entityManager;
        this.criteriaBuilder = entityManager.getCriteriaBuilder();
    }

    public Page<LocationRestriction> findAllWithFilters(PageHelper page, LocationRestrictionRequest request) {
        CriteriaQuery<LocationRestriction> criteriaQuery = criteriaBuilder.createQuery(LocationRestriction.class);
        Root<LocationRestriction> rootObj = criteriaQuery.from(LocationRestriction.class);
        Join<LocationRestriction, User> toCreatedByUserJoin = rootObj.join("createdBy");
        Join<LocationRestriction, User> toModifiedByUserJoin = rootObj.join("modifiedBy");

        List<Predicate> predicates = new ArrayList<Predicate>();

        criteriaQuery.multiselect(rootObj.get("id"), rootObj.get("name"), rootObj.get("code"), rootObj.get("createdAt"),
        ...
        TypedQuery<LocationRestriction> typedQuery = entityManager.createQuery(criteriaQuery);
    ...
    private List<Predicate> getPredicate(LocationRestrictionRequest request, Root<LocationRestriction> rootObj) {
    ...
    private void setOrder(PageHelper page, CriteriaQuery<LocationRestriction> criteriaQuery,
            Root<LocationRestriction> rootObj) {
    ...
    private long getAllRecordsCount(Predicate predicate) {
        ...
        Root<LocationRestriction> countRoot = countQuery.from(LocationRestriction.class);
