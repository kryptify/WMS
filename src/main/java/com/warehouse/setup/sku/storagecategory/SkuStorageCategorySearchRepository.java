...
@Repository
public class SkuStorageCategorySearchRepository {

    private final EntityManager entityManager;
    private final CriteriaBuilder criteriaBuilder;

    public SkuStorageCategorySearchRepository(EntityManager entityManager) {
        this.entityManager = entityManager;
        this.criteriaBuilder = entityManager.getCriteriaBuilder();
    }

    public Page<SkuStorageCategory> findAllWithFilters(PageHelper page, SkuStorageCategoryRequest request) {
        CriteriaQuery<SkuStorageCategory> criteriaQuery = criteriaBuilder.createQuery(SkuStorageCategory.class);
        Root<SkuStorageCategory> rootObj = criteriaQuery.from(SkuStorageCategory.class);
        Join<SkuStorageCategory, PrimaryCompany> toPrimaryCompanyJoin = rootObj.join("primaryCompany");
        Join<SkuStorageCategory, User> toCreatedByUserJoin = rootObj.join("createdBy");
        Join<SkuStorageCategory, User> toModifiedByUserJoin = rootObj.join("modifiedBy");
        ...
        criteriaQuery.multiselect(rootObj.get("id"), rootObj.get("name"), rootObj.get("code"),
                ...
                rootObj.get("isActive"), rootObj.get("createdAt"), rootObj.get("modifiedAt"),
        ...
        TypedQuery<SkuStorageCategory> typedQuery = entityManager.createQuery(criteriaQuery);
    ...
    private List<Predicate> getPredicate(SkuStorageCategoryRequest request, Root<SkuStorageCategory> rootObj) {
    ...
    private void setOrder(PageHelper page, CriteriaQuery<SkuStorageCategory> criteriaQuery,
            Root<SkuStorageCategory> rootObj) {
    ...
    private long getAllRecordsCount(Predicate predicate) {
        ...
        Root<SkuStorageCategory> countRoot = countQuery.from(SkuStorageCategory.class);
