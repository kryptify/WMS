...
public class SkuStorageCategory {
    ...
    public SkuStorageCategory() {
    }

    public SkuStorageCategory(Long id, String name, String code, Long primaryCompanyId,
            String primaryCompanyName, String primaryCompanyCode, Boolean isActive, Date createdAt, Date modifiedAt,
    ...
    public String toString() {
        return "SkuStorageCategory [code=" + code + ", createdAt=" + createdAt + ", createdBy=" + createdBy
                + ", createdById=" + createdById + ", createdByUserName=" + createdByUserName + ", id=" + id
                + ", isActive=" + isActive + ", modifiedAt=" + modifiedAt + ", modifiedBy=" + modifiedBy
