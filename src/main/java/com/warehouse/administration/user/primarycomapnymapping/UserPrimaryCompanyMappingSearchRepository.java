...
@Repository
public class UserPrimaryCompanyMappingSearchRepository {

    private final EntityManager entityManager;
    private final CriteriaBuilder criteriaBuilder;

    public UserPrimaryCompanyMappingSearchRepository(EntityManager entityManager) {
        this.entityManager = entityManager;
        this.criteriaBuilder = entityManager.getCriteriaBuilder();
    }

    public void deleteUserPrimaryCompanyMapping(Long userId, Long primaryCompanyId) {
        
        // create delete
        CriteriaDelete<UserPrimaryCompanyMapping> delete = criteriaBuilder.createCriteriaDelete(UserPrimaryCompanyMapping.class);
 
        // set the root class
        Root<UserPrimaryCompanyMapping> rootObj = delete.from(UserPrimaryCompanyMapping.class);
    ...
    public List<UserPrimaryCompanyMappingListResponse> findAllUserListWithPrimaryCompanyMappingList(UserRequest request) {
        CriteriaQuery<UserPrimaryCompanyMappingListResponse> criteriaQuery = criteriaBuilder
                .createQuery(UserPrimaryCompanyMappingListResponse.class);
        ...
        Join<User, UserRole> toUserRoleJoin = rootObj.join("primaryCompany");
        ...
        TypedQuery<UserPrimaryCompanyMappingListResponse> typedQuery = entityManager.createQuery(criteriaQuery);

        List<UserPrimaryCompanyMappingListResponse> primaryCompanyMappingListResponseList = typedQuery.getResultList();

        for (UserPrimaryCompanyMappingListResponse primaryCompanyMappingListResponse : primaryCompanyMappingListResponseList) {
            primaryCompanyMappingListResponse
                    .setUserRoleMappingList(findPrimaryCompanyMappingList(primaryCompanyMappingListResponse.getUserId()));
        }

        return primaryCompanyMappingListResponseList;
    }

    public List<UserPrimaryCompanyMapping> findPrimaryCompanyMappingList(Long userId) {
        CriteriaQuery<UserPrimaryCompanyMapping> criteriaQuery = criteriaBuilder.createQuery(UserPrimaryCompanyMapping.class);
        ...
        toPrimaryCompanyJoin.get("code"), rootObj.get("createdAt"), rootObj.get("modifiedAt"));
        ...
        TypedQuery<UserPrimaryCompanyMapping> typedQuery = entityManager.createQuery(criteriaQuery);
