...
public class UserSearchRepository {
    ...
    public List<User> findAllWithFilters(UserRequest request) {
        CriteriaQuery<User> criteriaQuery = criteriaBuilder.createQuery(User.class);
        Root<User> rootObj = criteriaQuery.from(User.class);
        ...
        criteriaQuery.multiselect(rootObj.get("id"), toWarehoueJoin.get("id"), toWarehoueJoin.get("name"),
                ...
                rootObj.get("intlDialCode"), rootObj.get("areaDialingCode"),

                rootObj.get("phone"), rootObj.get("extensionNo"), rootObj.get("fax"), rootObj.get("mobile"),

                rootObj.get("email"), rootObj.get("createdAt"), rootObj.get("modifiedAt"),
    ...
    public List<UserRoleMapping> findUserMappingList(Long userId) {
        ...
        rootObj.join("userRole");
        rootObj.join("createdBy");
        rootObj.join("modifiedBy");

        List<Predicate> predicates = new ArrayList<Predicate>();

        criteriaQuery.multiselect(rootObj.get("id"), rootObj.get("userRoleId"), rootObj.get("userRoleName"),
                rootObj.get("userRoleCode"), rootObj.get("createdAt"), rootObj.get("modifiedAt"));
