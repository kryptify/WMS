...
public class StockRequest {
    ...
    public String toString() {
        return "StockRequest{" +
                ...
                ", locationsMovedInUnit=" + locationsMovedInUnit +
                ", includeLocationsThatMovedIn=" + includeLocationsThatMovedIn +
                ", inventoryReconciliationInstructionName=" + inventoryReconciliationInstructionName +
                ", isBlindCount=" + isBlindCount +
                ", isExistingStockCountName=" + isExistingStockCountName +
                ", isRecountOnBatchNo=" + isRecountOnBatchNo +
                ", isRecountOnExpiryDate=" + isRecountOnExpiryDate +
                ", isRecountOnLocation=" + isRecountOnLocation +
                ", isRecountOnManufactureDate=" + isRecountOnManufactureDate +
                ", isRecountOnPackNumber=" + isRecountOnPackNumber +
                ", isRecountOnSerialNo=" + isRecountOnSerialNo +
                ", isRecountRequired=" + isRecountRequired +
                ", isSelected=" + isSelected +
                ", maxNoOfLinesPerInstruction=" + maxNoOfLinesPerInstruction +
                ", verifyBatchNo=" + verifyBatchNo +
                ", verifyExpiryDate=" + verifyExpiryDate +
                ", verifyManufactureDate=" + verifyManufactureDate +
                ", verifyPackNumber=" + verifyPackNumber +
