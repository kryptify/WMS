...
public class StockServiceImpl implements StockService {
    ...
    public String validateStockRequest(Stock theStockRequest) {
        ...
        PrimaryCompany primaryCompany = primaryCompanyRepository
                        .findById(theStockRequest.getPrimaryCompanyId())
        ...
        if (Objects.nonNull(theStockRequest.getLocationHierarchyID())) {
            ...
            for (String locationHierarchyIDStr: locationHierarchyIDArray) {
                ...
                LocationHierarchy locationHierarchy = locationHierarchyRepository.findById(locationHierarchyID).orElseThrow(
    ...
    public List<Stock> saveStocks(List<Stock> theStockList) {
        ...
        for (Stock stock : stockList) {
            if (Objects.isNull(stock.getStockNo()) || stock.getStockNo().isEmpty()){
                ...
                String stockNo =  stock.getPrimaryCompany().getDocNoPrefix() + "_" + stock.getWarehouse().getDocNoPrefix() +"_STI_"+year+"_"+strId;
