...
@Entity
@Table(name = "sku_type", schema = "public", uniqueConstraints = {
...
public class SkuType {
    ...
    public SkuType(Long id, String code, String name, Integer captureLotSize, Long primaryCompanyId, Date createdAt,
            Date modifiedAt, String createdByUserName, String modifiedByUserName, String primaryCompanyName,
    ...
    public String toString() {
        return "SkuType [captureLotSize=" + captureLotSize + ", code=" + code + ", createdAt=" + createdAt
                ...
                + ", modifiedById=" + modifiedById + ", modifiedByUserName=" + modifiedByUserName + ", name=" + name
